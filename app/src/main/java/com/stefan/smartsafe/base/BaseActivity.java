package com.stefan.smartsafe.base;
...
public abstract class BaseActivity extends FragmentActivity {
    ...
    protected void initHeadView() {
        ...
        tv_mTitle = view.findViewById(R.id.tv_title);

        tv_mLeft = view.findViewById(R.id.tv_back);
        tv_mLeft.setVisibility(View.VISIBLE);

        tv_mRight = view.findViewById(R.id.tv_right);
